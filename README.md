...
`0003_import_workspaces.sql` → `0004_import_execution_jobs.sql` → `0005_source_acquisitions.sql` → `0006_source_build_jobs.sql` → `0007_owner_auth.sql` → `0008_development_workspaces.sql` → `0009_secret_references.sql` → `0010_dns_change_proposals.sql` → `0011_release_evidence.sql` → `0012_rollback_history.sql`.
